...
[linked list](https://github.com/wzrdtales/visigoth-1/blob/fixup/balanceLinkedRing.js#L53).
...
Here is the [benchmark repo](https://github.com/WizardTales/microservice-benchmarks).
